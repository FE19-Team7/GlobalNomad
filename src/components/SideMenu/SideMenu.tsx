        ...
        >
            ...
            <nav className="flex flex-col gap-[14px]">
                ...
                <Link
                    ...
                    <IconList className={iconClass(pathname === '/mypage/reservations')} />
                    <span className="text-body-lg md:text-lg lg:text-body-lg">
                        예약내역
                    </span>
                </Link>
                ...
                <Link
                    ...
                    <IconSetting className={iconClass(pathname === '/mypage/activities')} />
                    <span className="text-body-lg md:text-lg lg:text-body-lg">
                        내 체험 관리
                    </span>
                </Link>
                ...
                <Link
                    ...
                    <IconCalendar className={iconClass(pathname === '/mypage/reservation-status')} />
                    <span className="text-body-lg md:text-lg lg:text-body-lg">
                        예약 현황
                    </span>
                </Link>
