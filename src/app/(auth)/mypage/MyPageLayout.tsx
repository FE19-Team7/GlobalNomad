...
export const getGlobalCancelHandler = (): (() => void) | null => globalCancelHandler;
    ...
    <main className="flex-1 py-6">
      <div className="w-full max-w-[980px] md:max-w-none lg:max-w-[980px] mx-auto px-6 md:px-[30px] lg:px-6">
        <div className="flex gap-8 md:gap-[0px] lg:gap-14">
          ...
          <div
            className={`w-full max-w-[375px] mx-auto md:max-w-none md:w-[220px] lg:w-[260px] md:flex-shrink-0 md:mx-0 ${
